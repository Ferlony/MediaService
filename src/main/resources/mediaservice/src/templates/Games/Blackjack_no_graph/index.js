...
let statuses = ["Want to play a round?", "HIT, STAND, or DOUBLE DOWN?", "HIT or STAND?", "You win!", "You Win!", 
            "Blackjack! You Win!", "It's a tie!", "Double Blackjack", "Dealer Blackjack!", "You Lose!", "You went over 21! You lose!"]
